...
`;
  ...
  if (userHover) {
        // clickBtn.addEventListener('mouseenter', transitionIn);
        // clickBtn.addEventListener('mouseleave', transitionIn);
    clickBtn.addEventListener('mouseenter', transitionIn);
    clickBtn.addEventListener('touchstart', transitionIn);
    clickBtn.addEventListener('mouseleave', transitionOut);
    clickBtn.addEventListener('touchend', transitionOut);
  }
